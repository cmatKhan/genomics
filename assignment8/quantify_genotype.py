...
def main(argv):
    ...
    snv_NA12878 = QuantifyIndividualGenotype('snv', snv_file, 'NA12878', variant_categories)

    # Count genotype calls that are homozygous reference, heterozygous, and homozygous alternate for NA12878
    snv_NA12878.quantifyGenotype()

    print(snv_NA12878.snv_indel_genotype_dict)
    #TODO: Report it in the form of a table with the four possibilities and their corresponding counts
...
def parseArgs(argv):
    ...
    # Also count the number of genotype calls with one or more alleles missing
